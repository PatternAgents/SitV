...
#define RSVP_PLATFORM_VERSION		3_5_1

/* ------------- PLATFORM and OPTIONS definitions ----------------------------------------------------*/
#define RSVP_DISPLAY_TYPE			SD1106		//! one of HEADLESS, SD1106, SSD1306, ILI9571, etc.
#define RSVP_DISPLAY_PORT			SPI			//! one of NONE, I2C, I2C1, I2C2, SPI, SPI1, Serial1, etc.
